...
extern __constant__ float canopy_heat_flux_rate_d;/* Heat flux rate for the canopy layer */
extern float* canopy_lad_d;          /* Base Address of memory containing leaf area density (LAD) field [m^{-1}] */
extern float* canopy_lai_d;          /* Base Address of memory containing leaf area index (LAI) field [-] */
